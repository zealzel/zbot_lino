...
def generate_launch_description():
    ...
    spawn_robot_node_tb3 = Node(
        ...
        arguments=[
            ...
            "linorobot2",
            "-x",
            str(map_defaultpos["tb3"][0]),
            "-y",
            str(map_defaultpos["tb3"][1]),
            "-z",
            str(map_defaultpos["tb3"][2]),
        ],
        condition=IfCondition(
            PythonExpression(["'", LaunchConfiguration("map_name"), "' == 'tb3'"])
        ),
    )
    ...
    spawn_robot_node_fit_office = Node(
        ...
        arguments=[
            ...
            "linorobot2",
            "-x",
            str(map_defaultpos["fit_office"][0]),
            "-y",
            str(map_defaultpos["fit_office"][1]),
            "-z",
            str(map_defaultpos["fit_office"][2]),
        ],
        condition=IfCondition(
            PythonExpression(
                ["'", LaunchConfiguration("map_name"), "' == 'fit_office'"]
            )
        ),
    )
    ...
    spawn_robot_node_factory_bk = Node(
        ...
        arguments=[
            ...
            "linorobot2",
            "-x",
            str(map_defaultpos["factory_bk"][0]),
            "-y",
            str(map_defaultpos["factory_bk"][1]),
            "-z",
            str(map_defaultpos["factory_bk"][2]),
        ],
        condition=IfCondition(
            PythonExpression(
                ["'", LaunchConfiguration("map_name"), "' == 'factory_bk'"]
            )
        ),
    )
